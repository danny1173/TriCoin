...
uint256 hashGenesisBlock("0xd590b290dda1246cca55f143a2d2537a4bac6bbe485dc5c7564d2192f346b498");
...
const string strMessageMagic = "TriCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1.4 * 24 * 60 * 60; // TriCoin: 0.35 days
static const int64 nTargetSpacing = 60; // TriCoin: 1 minute
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal tricoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TriCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbd52ec999da09c8ee5fb10e865079e935c68350d7ec3e2653e2b6fc5199514a0");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "The Internal Revenue Service (IRS) claimed Friday that";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        assert(block.hashMerkleRoot == uint256("0xd590b290dda1246cca55f143a2d2537a4bac6bbe485dc5c7564d2192f346b498"));
